...
public class OfertaDAO {
    ...
    public void insert(Oferta oferta) throws SQLException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            statement.setInt(1, oferta.getId_supermercado());
            statement.setInt(2, oferta.getId_produto());
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet result = statement.executeQuery()) {
                if (result.next()) {
                    ...
                    oferta.setId_supermercado(result.getInt("id_supermercado"));
                    oferta.setId_produto(result.getInt("id_produto"));
